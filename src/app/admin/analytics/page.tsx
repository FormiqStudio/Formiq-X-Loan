...
export default function AdminAnalyticsPage() {
  ...
  const loanAmountDistribution =
    analytics?.trends?.loanAmountDistribution || [];
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-slate-900">
                    {safeNumber(
                      analyticsData?.analytics?.overview?.totalUsers,
                      0
                    )}
                  </p>
                  <div className="flex items-center mt-2">
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-slate-900">
                    {formatCurrency(
                      safeNumber(
                        analyticsData?.analytics?.overview?.totalLoanAmount,
                        0
                      )
                    )}
                  </p>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-slate-900">
                    {safeNumber(
                      analyticsData?.analytics?.overview?.approvalRate,
                      0
                    )}
                    %
                  </p>
