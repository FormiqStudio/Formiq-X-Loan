...
export default function Header({ onMenuClick, user }: HeaderProps) {
  ...
  const notifications =
    notificationsData?.notifications?.map(safeNotification) || [];
            ...
            >
              <DropdownMenuTrigger asChild>
                <Button
                  variant="ghost"
                  size="sm"
                  className="relative hover:bg-slate-100 p-2"
                >
              ...
              <DropdownMenuContent
                align="end"
                className="w-80 max-h-[32rem] overflow-hidden"
              >
                      ...
                      return (
                        ...
                        >
                          <div className="flex items-start gap-3 w-full p-3 hover:bg-slate-50">
                            <div
                              className={`p-1.5 rounded-full bg-opacity-20 ${color.replace(
                                "text-",
                                "bg-"
                              )}`}
                            >
